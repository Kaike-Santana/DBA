...
/*           Descricao  :																		*/
/*::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
	Create Procedure Prc_Etl_Pagamentos_Contas_Movimentacoes_MBM As
/*::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
...
Left Join Plano_Contas					 On  Plano_Contas.cod_planocontas = Fato.cod_contacontabildb  collate sql_latin1_general_cp1_ci_ai 
										 And Plano_Contas.descricao		  =	Fato.descricao_cc_db      collate sql_latin1_general_cp1_ci_ai  and Plano_Contas.tipo = 'D'
Left join Plano_Contas As PC_2			 On  PC_2.cod_planocontas		  = Fato.cod_contacontabilcr  collate sql_latin1_general_cp1_ci_ai 
										 And PC_2.descricao				  =	Fato.descricao_cc_cr      collate sql_latin1_general_cp1_ci_ai and PC_2.tipo = 'C'
Where Exists (
			   Select 1
			   From #PagContas Dim
...
Where Not Exists (
				  Select 1
				  From Pagamentos_Contas_Mov Dim_2
				  Where Dim_2.Pk = SubQuery.Pk collate sql_latin1_general_cp1_ci_ai
			     )
/*::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
