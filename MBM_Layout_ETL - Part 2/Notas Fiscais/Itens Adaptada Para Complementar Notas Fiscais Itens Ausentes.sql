...
from (
Select 
	[chave_emp_+_cod_item] = trim(empresas + cod_item collate latin1_general_ci_ai)
,	*
...
Select 
	...
	id_grupo_estoque = isnull(#Tb_Aux_Grupo_e_SG.id_grupo_estoque,20),		--= tb_grupo estoque mbm
...
--where fato.codigo not in( '10134240','10134241', '10134239' )
...
Select 
	Id_Item					= min(Itens.Id_Item)
,	Id_Empresa_Grupo		= 1584 --> Mudar Aqui Para a Empresa Que Estiver Fazendo!
...
,	Id_Empresa_Grupo		= 1584 --> Mudar Aqui Para a Empresa Que Estiver Fazendo!
,	Id_Origem_Merc			= Null
,	Id_Familia_Industrial	= Null
,	Cod_Antigo				= Codigo
,	Cod_Reduzido_Antigo		= Null
,	incl_data				= getdate()
,	incl_user				= 'ksantana'
,	incl_device				= 'PC'
,	modi_data				= null
