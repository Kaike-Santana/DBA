...
WHERE STATUS = '10c' 
SELECT * FROM TEMP_MARCACAO_ESTRATEGIA
/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
...
/* FUNÇÃO DO SELECT ABAIXO É PEGAR AS DATAS DISTINTAS PARA COLOCAR NO CASE ABAIXO */
/*******************************************/
SELECT DISTINCT Recebido_Banco
FROM TEMP_MARCACAO_ESTRATEGIA
WHERE CARTEIRA_PLAN_1 = 'INDENI'
ORDER BY Recebido_Banco DESC
/*******************************************/
/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
...
SELECT	 
			...
			,CASE 
					...
					AND Recebido_Banco NOT IN ('2021-12-07','2021-11-19','2021-11-17')
					THEN 'OK'
			...
			,CASE 
					...
					AND Recebido_Banco 	  IN ('2021-12-07','2021-11-19','2021-11-17')
					THEN 'OK'
					ELSE ESTRATEGIA_PLAN_2 
...
SELECT	 
			...
			,CASE 
					WHEN PRODUTO = 'BMG'	
					AND RECORRENCIA = 'i' 
					AND Recebido_Banco NOT IN ('2022-01-12','2022-01-11','2022-01-10','2022-01-08','2022-01-07','2022-01-06','2022-01-05','2022-01-04','2022-01-03','2021-12-30','2021-12-29','2021-12-28')
					AND ESTRATEGIA_PLAN_2 = 'Discador' 
					THEN 'OK' 
					ELSE ESTRATEGIA_PLAN_2
			...
			,CASE 
					WHEN PRODUTO = 'PAN'	
					AND RECORRENCIA = 'i' 
					AND Recebido_Banco IN ('2022-01-12','2022-01-11','2022-01-10','2022-01-08','2022-01-07','2022-01-06','2022-01-05','2022-01-04','2022-01-03','2021-12-30','2021-12-29','2021-12-28')
					AND ESTRATEGIA_PLAN_2 = 'Discador' 
					THEN 'OK' 
					ELSE ESTRATEGIA_PLAN_2
...
/*:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::*/
DROP TABLE IF EXISTS ACABOU;
CREATE TEMPORARY TABLE ACABOU AS 
SELECT 
 		* /*TROCAR POR > * PARA VERIFICAÇÃO*/
...
SELECT * 
FROM ACABOU
WHERE TO_DO_ESTRATEGIA IS NOT NULL
